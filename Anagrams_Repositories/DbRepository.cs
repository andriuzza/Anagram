...
namespace Anagrams_Repositories
{
    public class DbRepository : IWordRepository<string>
    {
        ...
        public bool InsertLogUser(long TIME, string ip, string query)
        {
            ...
            insert.CommandText = "INSERT INTO dbo.IPLogUser (IP, Time, SortedWord) VALUES(@FN, @LN, @MN)";
            ...
            SqlDataAdapter adapter = new SqlDataAdapter("SELECT IP, Time, SortedWord FROM dbo.IPLogUser", cn);

            adapter.InsertCommand = insert;

            DataSet ds = new DataSet();
            adapter.Fill(ds, "dbo.IPLogUser");
        ...
        private Dictionary<string, int> GetTimeAndStrings(string IP)
        {
            ...
            SqlCommand command = new SqlCommand("SELECT TIME, SortedWord FROM dbo.IPLogUser " +
                                                    "WHERE IP = @FN", cn);
            ...
            adapter.Fill(dataSet, "dbo.IPLogUser");
